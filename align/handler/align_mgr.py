...
def align_massechet(audio_repo, audio_file_template, doc_repo, doc_file_template, output_repo, start_page, start_search_page=2):
    ...
    while index < number_of_files + start_page:            
        ...
        elif index == number_of_files + start_page - 1:
        ...
        start_search_index -= END_SEARCHING_INDEX
        index += 1   
